...
import { register, login, logout, getProfile, updateProfile, deleteUser } from '../controllers/auth.controller.js';
...
router.delete('/delete/', verifyUserToken, deleteUser);  // Delete user's profile
